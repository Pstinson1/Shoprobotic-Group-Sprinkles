...
#Region "--> Device Management "
    ...
    Friend Const DIGCF_ALLCLASSES As Short = &H4
    Friend Const MAX_DEV_LEN As Short = 1000

    Friend Const SPDRP_ADDRESS As Short = &H1C
    Friend Const SPDRP_BUSNUMBER As Short = &H15
    Friend Const SPDRP_BUSTYPEGUID As Short = &H13
    Friend Const SPDRP_CAPABILITIES As Short = &HF
    Friend Const SPDRP_CHARACTERISTICS As Short = &H1B
    Friend Const SPDRP_CLASS As Short = 7
    Friend Const SPDRP_CLASSGUID As Short = 8
    Friend Const SPDRP_COMPATIBLEIDS As Short = 2
    Friend Const SPDRP_CONFIGFLAGS As Short = &HA
    Friend Const SPDRP_DEVICE_POWER_DATA As Short = &H1E
    Friend Const SPDRP_DEVICEDESC As Short = 0
    Friend Const SPDRP_DEVTYPE As Short = &H19
    Friend Const SPDRP_DRIVER As Short = 9
    Friend Const SPDRP_ENUMERATOR_NAME As Short = &H16
    Friend Const SPDRP_EXCLUSIVE As Short = &H1A
    Friend Const SPDRP_FRIENDLYNAME As Short = &HC
    Friend Const SPDRP_HARDWAREID As Short = 1
    Friend Const SPDRP_LEGACYBUSTYPE As Short = &H14
    Friend Const SPDRP_LOCATION_INFORMATION As Short = &HD
    Friend Const SPDRP_LOWERFILTERS As Short = &H12
    Friend Const SPDRP_MFG As Short = &HB
    Friend Const SPDRP_PHYSICAL_DEVICE_OBJECT_NAME As Short = &HE
    Friend Const SPDRP_REMOVAL_POLICY As Short = &H1F
    Friend Const SPDRP_REMOVAL_POLICY_HW_DEFAULT As Short = &H20
    Friend Const SPDRP_REMOVAL_POLICY_OVERRIDE As Short = &H21
    Friend Const SPDRP_SECURITY As Short = &H17
    Friend Const SPDRP_SECURITY_SDS As Short = &H18
    Friend Const SPDRP_SERVICE As Short = 4
    Friend Const SPDRP_UI_NUMBER As Short = &H10
    Friend Const SPDRP_UI_NUMBER_DESC_FORMAT As Short = &H1D
    Friend Const SPDRP_UPPERFILTERS As Short = &H11
